                      ...
                      >
                        ...
                        <td className="p-2.5 min-w-0">
                          <div className="flex items-center gap-2.5 min-w-0">
                            ...
                            <div
                              className={`w-12 h-8 rounded-lg flex items-center justify-center shrink-0 text-white shadow-2xs overflow-hidden relative border border-slate-200/40 ${
              ...
              {filteredFiles.map((file) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-full h-28 bg-slate-900 rounded-xl flex items-center justify-center mb-2.5 relative overflow-hidden group-hover:opacity-95 transition-all border border-slate-200/40">
                      {file.type === "video" && videoThumb ? (
                        <img
                          src={videoThumb}
                          alt={file.title}
